"""
Spencer Stuart Plugin — Executive search firm.
...
class SpencerStuartPlugin(SourcePlugin):
    """Spencer Stuart — senior executive search and leadership advisory."""

    SPEC = ALL_PLUGINS["spencer_stuart"]

    @retry(stop=stop_after_attempt(3), wait=wait_exponential(min=1, max=15))
    async def discover(self, query: ContactQuery) -> list[SourceResult]:
        results: list[SourceResult] = []
        url = "https://www.spencerstuart.com/consultants"
            ...
            for profile in profiles[:10]:
                ...
                if name_match:
                    results.append(self._make_source_result(
                        ...
                        extracted_company="Spencer Stuart",
